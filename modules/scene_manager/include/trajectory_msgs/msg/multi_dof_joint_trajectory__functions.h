 ...
 * calls trajectory_msgs__msg__MultiDOFJointTrajectory__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls trajectory_msgs__msg__MultiDOFJointTrajectory__Sequence__fini() on the array,
