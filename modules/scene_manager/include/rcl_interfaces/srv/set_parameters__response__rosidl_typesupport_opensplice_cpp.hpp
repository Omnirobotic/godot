...
#ifndef RCL_INTERFACES__SRV__SET_PARAMETERS__RESPONSE__ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_HPP_
#define RCL_INTERFACES__SRV__SET_PARAMETERS__RESPONSE__ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_HPP_
...
const char *
serialize__SetParameters_Response(
  const void * untyped_ros_message,
  void * serialized_data);

ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_rcl_interfaces
const char *
deserialize__SetParameters_Response(
...
#endif  // RCL_INTERFACES__SRV__SET_PARAMETERS__RESPONSE__ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_HPP_
