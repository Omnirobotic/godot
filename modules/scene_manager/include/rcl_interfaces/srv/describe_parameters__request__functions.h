 ...
 * calls rcl_interfaces__srv__DescribeParameters_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls rcl_interfaces__srv__DescribeParameters_Request__Sequence__fini() on the array,
