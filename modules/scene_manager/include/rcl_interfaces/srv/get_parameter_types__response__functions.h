 ...
 * calls rcl_interfaces__srv__GetParameterTypes_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls rcl_interfaces__srv__GetParameterTypes_Response__Sequence__fini() on the array,
