...
#ifndef RCL_INTERFACES__MSG__PARAMETER_EVENT_DESCRIPTORS__ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_HPP_
#define RCL_INTERFACES__MSG__PARAMETER_EVENT_DESCRIPTORS__ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_HPP_
...
const char *
serialize__ParameterEventDescriptors(
  const void * untyped_ros_message,
  void * serialized_data);

ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_rcl_interfaces
const char *
deserialize__ParameterEventDescriptors(
...
#endif  // RCL_INTERFACES__MSG__PARAMETER_EVENT_DESCRIPTORS__ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_HPP_
