 ...
 * calls rcl_interfaces__msg__ParameterEventDescriptors__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls rcl_interfaces__msg__ParameterEventDescriptors__Sequence__fini() on the array,
