...
#ifndef Log_Plugin_2076272404_h
#define Log_Plugin_2076272404_h
...
namespace rcl_interfaces {
    namespace msg {
        namespace dds_ {
            ...
            #define Log_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define Log_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define Log_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define Log_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define Log_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern Log_*
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            Log_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                Log_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern void
            Log_Plugin_delete(struct PRESTypePlugin *);
