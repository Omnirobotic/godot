...
ROSIDL_GENERATOR_C_PUBLIC_composition
bool
composition__srv__LoadNode_Request__Sequence__init(composition__srv__LoadNode_Request__Sequence * array, size_t size);
...
ROSIDL_GENERATOR_C_PUBLIC_composition
void
composition__srv__LoadNode_Request__Sequence__fini(composition__srv__LoadNode_Request__Sequence * array);

/// Create array of composition/LoadNode_Request messages.
/**
 * It allocates the memory for the array and
 * calls composition__srv__LoadNode_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_composition
composition__srv__LoadNode_Request__Sequence *
composition__srv__LoadNode_Request__Sequence__create(size_t size);

/// Destroy array of composition/LoadNode_Request messages.
/**
 * It calls composition__srv__LoadNode_Request__Sequence__fini() on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_composition
void
composition__srv__LoadNode_Request__Sequence__destroy(composition__srv__LoadNode_Request__Sequence * array);
