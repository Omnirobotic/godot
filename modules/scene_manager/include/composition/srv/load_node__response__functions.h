...
ROSIDL_GENERATOR_C_PUBLIC_composition
bool
composition__srv__LoadNode_Response__Sequence__init(composition__srv__LoadNode_Response__Sequence * array, size_t size);
...
ROSIDL_GENERATOR_C_PUBLIC_composition
void
composition__srv__LoadNode_Response__Sequence__fini(composition__srv__LoadNode_Response__Sequence * array);

/// Create array of composition/LoadNode_Response messages.
/**
 * It allocates the memory for the array and
 * calls composition__srv__LoadNode_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_composition
composition__srv__LoadNode_Response__Sequence *
composition__srv__LoadNode_Response__Sequence__create(size_t size);

/// Destroy array of composition/LoadNode_Response messages.
/**
 * It calls composition__srv__LoadNode_Response__Sequence__fini() on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_composition
void
composition__srv__LoadNode_Response__Sequence__destroy(composition__srv__LoadNode_Response__Sequence * array);
