...
//  
//  File name: Sample_FrameGraph_Request_.h
//  Source: tf2_msgs\srv\dds_opensplice\Sample_FrameGraph_Request_.idl
//  Generated: timestamp removed to make the build reproducible
//  OpenSplice 6.9.190403OSS
//  
//******************************************************************
#ifndef _SAMPLE_FRAMEGRAPH_REQUEST__H_
#define _SAMPLE_FRAMEGRAPH_REQUEST__H_
...
namespace tf2_msgs
{
   namespace srv
   {
      namespace dds_
      {
         struct Sample_FrameGraph_Request_;
