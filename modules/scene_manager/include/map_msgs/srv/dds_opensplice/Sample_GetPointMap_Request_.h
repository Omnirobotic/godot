...
//  
//  File name: Sample_GetPointMap_Request_.h
//  Source: map_msgs\srv\dds_opensplice\Sample_GetPointMap_Request_.idl
//  Generated: timestamp removed to make the build reproducible
//  OpenSplice 6.9.190403OSS
//  
//******************************************************************
#ifndef _SAMPLE_GETPOINTMAP_REQUEST__H_
#define _SAMPLE_GETPOINTMAP_REQUEST__H_
...
namespace map_msgs
{
   namespace srv
   {
      namespace dds_
      {
         struct Sample_GetPointMap_Request_;
