...
//  
//  File name: Sample_ProjectedMapsInfo_Response_.h
//  Source: map_msgs\srv\dds_opensplice\Sample_ProjectedMapsInfo_Response_.idl
//  Generated: timestamp removed to make the build reproducible
//  OpenSplice 6.9.190403OSS
//  
//******************************************************************
#ifndef _SAMPLE_PROJECTEDMAPSINFO_RESPONSE__H_
#define _SAMPLE_PROJECTEDMAPSINFO_RESPONSE__H_

#include "sacpp_mapping.h"
#include "ProjectedMapsInfo_Response_.h"
...
namespace map_msgs
{
   namespace srv
   {
      namespace dds_
      {
         struct Sample_ProjectedMapsInfo_Response_;
         ...
         struct ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_PUBLIC_map_msgs Sample_ProjectedMapsInfo_Response_
         {
               ...
               ProjectedMapsInfo_Response_ response_;
         };
