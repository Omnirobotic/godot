...
#ifndef GoalStatus__1480109258_h
#define GoalStatus__1480109258_h
...
namespace action_msgs {
    namespace msg {
        namespace dds_ {
            static const DDS_Octet GoalStatus__STATUS_UNKNOWN= 0;
            static const DDS_Octet GoalStatus__STATUS_ACCEPTED= 1;
            static const DDS_Octet GoalStatus__STATUS_EXECUTING= 2;
            static const DDS_Octet GoalStatus__STATUS_CANCELING= 3;
            static const DDS_Octet GoalStatus__STATUS_SUCCEEDED= 4;
            static const DDS_Octet GoalStatus__STATUS_CANCELED= 5;
            static const DDS_Octet GoalStatus__STATUS_ABORTED= 6;
