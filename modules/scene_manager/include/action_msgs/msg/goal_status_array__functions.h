...
/// Initialize action_msgs/GoalStatusArray message.
/**
 * If the init function is called twice for the same message without
 * calling fini inbetween previously allocated memory will be leaked.
 * \param[in,out] msg The previously allocated message pointer.
 * Fields without a default value will not be initialized by this function.
 * You might want to call memset(msg, 0, sizeof(action_msgs__msg__GoalStatusArray)) before
 * or use action_msgs__msg__GoalStatusArray__create() to allocate and initialize the message.
...
/// Finalize action_msgs/GoalStatusArray message.
/**
...
/// Create action_msgs/GoalStatusArray message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls action_msgs__msg__GoalStatusArray__init().
...
/// Destroy action_msgs/GoalStatusArray message.
/**
 * It calls action_msgs__msg__GoalStatusArray__fini() and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_action_msgs
void
...
/// Initialize array of action_msgs/GoalStatusArray messages.
/**
 * It allocates the memory for the number of elements and
 * calls action_msgs__msg__GoalStatusArray__init() for each element of the array.
...
/// Finalize array of action_msgs/GoalStatusArray messages.
/**
 * It calls action_msgs__msg__GoalStatusArray__fini() for each element of the array and
...
/// Create array of action_msgs/GoalStatusArray messages.
/**
 * It allocates the memory for the array and
 * calls action_msgs__msg__GoalStatusArray__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of action_msgs/GoalStatusArray messages.
/**
 * It calls action_msgs__msg__GoalStatusArray__Sequence__fini() on the array,
