...
#ifndef _WIN32
# define DEPRECATED_action_msgs_msg_GoalStatus __attribute__((deprecated))
#else
# define DEPRECATED_action_msgs_msg_GoalStatus __declspec(deprecated)
#endif
...
struct GoalStatus_
{
  ...
  typedef DEPRECATED_action_msgs_msg_GoalStatus
    std::shared_ptr<action_msgs::msg::GoalStatus_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED_action_msgs_msg_GoalStatus
    std::shared_ptr<action_msgs::msg::GoalStatus_<ContainerAllocator> const>
