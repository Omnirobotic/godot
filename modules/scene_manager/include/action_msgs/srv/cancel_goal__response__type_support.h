...
#ifndef ACTION_MSGS__SRV__CANCEL_GOAL__RESPONSE__TYPE_SUPPORT_H_
#define ACTION_MSGS__SRV__CANCEL_GOAL__RESPONSE__TYPE_SUPPORT_H_
...
#endif  // ACTION_MSGS__SRV__CANCEL_GOAL__RESPONSE__TYPE_SUPPORT_H_
