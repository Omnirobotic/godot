...
#ifndef UUID_Plugin_1199467504_h
#define UUID_Plugin_1199467504_h
...
namespace unique_identifier_msgs {
    namespace msg {
        namespace dds_ {
            ...
            #define unique_identifier_msgs__UUID__octet_array_16Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define unique_identifier_msgs__UUID__octet_array_16Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define unique_identifier_msgs__UUID__octet_array_16Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define unique_identifier_msgs__UUID__octet_array_16Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define unique_identifier_msgs__UUID__octet_array_16Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern unique_identifier_msgs__UUID__octet_array_16*
            ...
            unique_identifier_msgs__UUID__octet_array_16PluginSupport_copy_data(
                unique_identifier_msgs__UUID__octet_array_16 *out,
                const unique_identifier_msgs__UUID__octet_array_16 *in);
            ...
            * ------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool
            unique_identifier_msgs__UUID__octet_array_16Plugin_skip(
                PRESTypePluginEndpointData endpoint_data,
                struct RTICdrStream *stream, 
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            unique_identifier_msgs__UUID__octet_array_16Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                unique_identifier_msgs__UUID__octet_array_16 * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
...
#endif /* UUID_Plugin_1199467504_h */
