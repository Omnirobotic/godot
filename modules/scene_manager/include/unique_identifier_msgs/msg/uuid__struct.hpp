...
#ifndef _WIN32
# define DEPRECATED_unique_identifier_msgs_msg_UUID __attribute__((deprecated))
#else
# define DEPRECATED_unique_identifier_msgs_msg_UUID __declspec(deprecated)
#endif
...
struct UUID_
{
  ...
  typedef DEPRECATED_unique_identifier_msgs_msg_UUID
    std::shared_ptr<unique_identifier_msgs::msg::UUID_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED_unique_identifier_msgs_msg_UUID
    std::shared_ptr<unique_identifier_msgs::msg::UUID_<ContainerAllocator> const>
