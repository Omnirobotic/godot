...
#ifndef EXAMPLE_INTERFACES__ACTION__FIBONACCI__FEEDBACK__ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_HPP_
#define EXAMPLE_INTERFACES__ACTION__FIBONACCI__FEEDBACK__ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_HPP_

#include "example_interfaces/action/fibonacci__feedback__struct.hpp"
#include "example_interfaces/action/dds_opensplice/ccpp_Fibonacci_Feedback_.h"
...
const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_opensplice_cpp, example_interfaces, action, Fibonacci_Feedback)();

#ifdef __cplusplus
}
#endif

#endif  // EXAMPLE_INTERFACES__ACTION__FIBONACCI__FEEDBACK__ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_HPP_
