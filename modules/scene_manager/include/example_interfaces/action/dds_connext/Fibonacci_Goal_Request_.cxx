...
namespace example_interfaces {
    namespace action {
        namespace dds_ {
            ...
            /* ========================================================================= */
            const char *Fibonacci_Goal_Request_TYPENAME = "example_interfaces::action::dds_::Fibonacci_Goal_Request_";
            ...
            DDS_TypeCode* Fibonacci_Goal_Request__get_typecode()
            {
                ...
                {{
                        ...
                        -1, /*Ignored*/
                        (char *)"example_interfaces::action::dds_::Fibonacci_Goal_Request_", /* Name */
                        NULL, /* Ignored */      
                        0, /* Ignored */
                        0, /* Ignored */
                        NULL, /* Ignored */
            ...
            RTIBool Fibonacci_Goal_Request__initialize(
                ...
                return example_interfaces::action::dds_::Fibonacci_Goal_Request__initialize_ex(sample,RTI_TRUE,RTI_TRUE);
            }
                ...
                Fibonacci_Goal_Request_* sample,RTIBool allocatePointers, RTIBool allocateMemory)
            {
                ...
                return example_interfaces::action::dds_::Fibonacci_Goal_Request__initialize_w_params(
                    sample,&allocParams);
                ...
                Fibonacci_Goal_Request_* sample)
            {
                ...
                example_interfaces::action::dds_::Fibonacci_Goal_Request__finalize_ex(sample,RTI_TRUE);
            }
                ...
                Fibonacci_Goal_Request_* sample,RTIBool deletePointers)
            {
                ...
                example_interfaces::action::dds_::Fibonacci_Goal_Request__finalize_w_params(
            ...
            */
            ...
            #define T_initialize_w_params example_interfaces::action::dds_::Fibonacci_Goal_Request__initialize_w_params

            #define T_finalize_w_params   example_interfaces::action::dds_::Fibonacci_Goal_Request__finalize_w_params
            #define T_copy       example_interfaces::action::dds_::Fibonacci_Goal_Request__copy
