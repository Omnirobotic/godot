 ...
 * calls geometry_msgs__msg__PoseWithCovarianceStamped__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls geometry_msgs__msg__PoseWithCovarianceStamped__Sequence__fini() on the array,
