 ...
 * calls geometry_msgs__msg__TwistWithCovarianceStamped__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls geometry_msgs__msg__TwistWithCovarianceStamped__Sequence__fini() on the array,
