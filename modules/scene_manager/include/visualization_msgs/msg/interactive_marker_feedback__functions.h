 ...
 * calls visualization_msgs__msg__InteractiveMarkerFeedback__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls visualization_msgs__msg__InteractiveMarkerFeedback__Sequence__fini() on the array,
