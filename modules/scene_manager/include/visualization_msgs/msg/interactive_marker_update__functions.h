 ...
 * calls visualization_msgs__msg__InteractiveMarkerUpdate__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls visualization_msgs__msg__InteractiveMarkerUpdate__Sequence__fini() on the array,
