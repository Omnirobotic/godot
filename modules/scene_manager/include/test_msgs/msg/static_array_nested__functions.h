...
ROSIDL_GENERATOR_C_PUBLIC_test_msgs
bool
test_msgs__msg__StaticArrayNested__Sequence__init(test_msgs__msg__StaticArrayNested__Sequence * array, size_t size);
...
ROSIDL_GENERATOR_C_PUBLIC_test_msgs
void
test_msgs__msg__StaticArrayNested__Sequence__fini(test_msgs__msg__StaticArrayNested__Sequence * array);

/// Create array of test_msgs/StaticArrayNested messages.
/**
 * It allocates the memory for the array and
 * calls test_msgs__msg__StaticArrayNested__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_test_msgs
test_msgs__msg__StaticArrayNested__Sequence *
test_msgs__msg__StaticArrayNested__Sequence__create(size_t size);

/// Destroy array of test_msgs/StaticArrayNested messages.
/**
 * It calls test_msgs__msg__StaticArrayNested__Sequence__fini() on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_test_msgs
void
test_msgs__msg__StaticArrayNested__Sequence__destroy(test_msgs__msg__StaticArrayNested__Sequence * array);
