...
struct StaticArrayPrimitives_
{
  ...
  explicit StaticArrayPrimitives_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    ...
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
    {
      std::fill<typename std::array<uint8_t, 3>::iterator, uint8_t>(this->byte_values.begin(), this->byte_values.end(), 0);
      std::fill<typename std::array<char, 3>::iterator, char>(this->char_values.begin(), this->char_values.end(), 0);
    }
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
    {
