...
#ifndef TEST_MSGS__ACTION__NESTED_MESSAGE__FEEDBACK__STRUCT_HPP_
#define TEST_MSGS__ACTION__NESTED_MESSAGE__FEEDBACK__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED_test_msgs_action_NestedMessage_Feedback __attribute__((deprecated))
#else
# define DEPRECATED_test_msgs_action_NestedMessage_Feedback __declspec(deprecated)
#endif
...
struct NestedMessage_Feedback_
{
  ...
  typedef DEPRECATED_test_msgs_action_NestedMessage_Feedback
    std::shared_ptr<test_msgs::action::NestedMessage_Feedback_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED_test_msgs_action_NestedMessage_Feedback
    std::shared_ptr<test_msgs::action::NestedMessage_Feedback_<ContainerAllocator> const>
...
#endif  // TEST_MSGS__ACTION__NESTED_MESSAGE__FEEDBACK__STRUCT_HPP_
