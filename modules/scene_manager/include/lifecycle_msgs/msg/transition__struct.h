...
enum
{
  lifecycle_msgs__msg__Transition__TRANSITION_UNCONFIGURED_SHUTDOWN = 5u
};
// TRANSITION_INACTIVE_SHUTDOWN
enum
{
  lifecycle_msgs__msg__Transition__TRANSITION_INACTIVE_SHUTDOWN = 6u
};
// TRANSITION_ACTIVE_SHUTDOWN
enum
{
  lifecycle_msgs__msg__Transition__TRANSITION_ACTIVE_SHUTDOWN = 7u
};
// TRANSITION_DESTROY
enum
{
  lifecycle_msgs__msg__Transition__TRANSITION_DESTROY = 8u
};
...
enum
{
  lifecycle_msgs__msg__Transition__TRANSITION_ON_SHUTDOWN_SUCCESS = 50u
};
// TRANSITION_ON_SHUTDOWN_FAILURE
enum
{
  lifecycle_msgs__msg__Transition__TRANSITION_ON_SHUTDOWN_FAILURE = 51u
};
// TRANSITION_ON_SHUTDOWN_ERROR
enum
{
  lifecycle_msgs__msg__Transition__TRANSITION_ON_SHUTDOWN_ERROR = 52u
};
