...
//  
//  File name: Sample_GetAvailableStates_Response_.h
//  Source: lifecycle_msgs\srv\dds_opensplice\Sample_GetAvailableStates_Response_.idl
//  Generated: timestamp removed to make the build reproducible
//  OpenSplice 6.9.190403OSS
//  
//******************************************************************
#ifndef _SAMPLE_GETAVAILABLESTATES_RESPONSE__H_
#define _SAMPLE_GETAVAILABLESTATES_RESPONSE__H_

#include "sacpp_mapping.h"
#include "GetAvailableStates_Response_.h"
...
namespace lifecycle_msgs
{
   namespace srv
   {
      namespace dds_
      {
         struct Sample_GetAvailableStates_Response_;
         ...
         struct ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_PUBLIC_lifecycle_msgs Sample_GetAvailableStates_Response_
         {
               ...
               GetAvailableStates_Response_ response_;
         };
