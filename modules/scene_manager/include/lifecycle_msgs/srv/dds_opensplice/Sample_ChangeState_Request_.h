...
//  
//  File name: Sample_ChangeState_Request_.h
//  Source: lifecycle_msgs\srv\dds_opensplice\Sample_ChangeState_Request_.idl
//  Generated: timestamp removed to make the build reproducible
//  OpenSplice 6.9.190403OSS
//  
//******************************************************************
#ifndef _SAMPLE_CHANGESTATE_REQUEST__H_
#define _SAMPLE_CHANGESTATE_REQUEST__H_
...
namespace lifecycle_msgs
{
   namespace srv
   {
      namespace dds_
      {
         struct Sample_ChangeState_Request_;
