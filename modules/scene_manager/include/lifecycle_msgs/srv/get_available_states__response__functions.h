 ...
 * calls lifecycle_msgs__srv__GetAvailableStates_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls lifecycle_msgs__srv__GetAvailableStates_Response__Sequence__fini() on the array,
