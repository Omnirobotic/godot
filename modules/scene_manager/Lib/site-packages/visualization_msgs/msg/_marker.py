...
class Metaclass(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg_marker
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg_marker
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg_marker
            cls._TYPE_SUPPORT = module.type_support_msg__msg_marker
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg_marker
...
class Marker(metaclass=Metaclass):
    ...
    def action(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'action' field must of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
    ...
    def frame_locked(self, value):
        if __debug__:
            assert \
                ...
                "The 'frame_locked' field must of type 'bool'"
    ...
    def mesh_resource(self, value):
        if __debug__:
            assert \
                isinstance(value, str), \
                "The 'mesh_resource' field must of type 'str'"
    ...
    def mesh_use_embedded_materials(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'mesh_use_embedded_materials' field must of type 'bool'"
