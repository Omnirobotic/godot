...
class Metaclass(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg_parameter_event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg_parameter_event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg_parameter_event
            cls._TYPE_SUPPORT = module.type_support_msg__msg_parameter_event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg_parameter_event
...
class ParameterEvent(metaclass=Metaclass):
    ...
    _fields_and_field_types = {
        ...
        'node': 'string',
        'new_parameters': 'rcl_interfaces/Parameter[]',
        'changed_parameters': 'rcl_interfaces/Parameter[]',
        'deleted_parameters': 'rcl_interfaces/Parameter[]',
    }
    ...
    def node(self, value):
        if __debug__:
            assert \
                ...
                "The 'node' field must of type 'str'"
        self._node = value
