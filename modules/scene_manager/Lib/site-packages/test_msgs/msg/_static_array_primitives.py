...
class Metaclass(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg_static_array_primitives
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg_static_array_primitives
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg_static_array_primitives
            cls._TYPE_SUPPORT = module.type_support_msg__msg_static_array_primitives
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg_static_array_primitives
...
class StaticArrayPrimitives(metaclass=Metaclass):
    ...
    def __init__(self, **kwargs):
        ...
        self.char_values = kwargs.get(
            'char_values',
            [chr(0) for x in range(3)]
        )
        self.float32_values = kwargs.get(
            'float32_values',
            [float() for x in range(3)]
        )
    ...
    def char_values(self, value):
        if __debug__:
            ...
            assert \
                ...
                "The 'char_values' field must be a set or sequence with length 3 and each value of type 'str' and each characters ord() in [-128, 127]"
