...
class Metaclass(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg_bounded_array_primitives
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg_bounded_array_primitives
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg_bounded_array_primitives
            cls._TYPE_SUPPORT = module.type_support_msg__msg_bounded_array_primitives
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg_bounded_array_primitives
    ...
    def check(self, value):
        if __debug__:
            ...
            assert value >= -2147483648 and value < 2147483648, \
                "The 'check' field must be an integer in [-2147483648, 2147483647]"
        self._check = value
