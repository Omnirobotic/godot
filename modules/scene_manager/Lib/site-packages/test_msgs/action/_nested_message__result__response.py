...
class Metaclass(type):
    """Metaclass of message 'NestedMessage_Result_Response'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger('rosidl_generator_py.NestedMessage_Result_Response')
            logger.debug(
                'Failed to import needed modules for type support:\n' + traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__action_nested_message__result__response
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__action_nested_message__result__response
            cls._CONVERT_TO_PY = module.convert_to_py_msg__action_nested_message__result__response
            cls._TYPE_SUPPORT = module.type_support_msg__action_nested_message__result__response
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__action_nested_message__result__response
...
class NestedMessage_Result_Response(metaclass=Metaclass):
    """Message class 'NestedMessage_Result_Response'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.action_status = kwargs.get('action_status', int())
        from test_msgs.msg import Builtins
    ...
    def action_status(self, value):
        if __debug__:
            assert \
                ...
                "The 'action_status' field must of type 'int'"
            assert value >= -128 and value < 128, \
                "The 'action_status' field must be an integer in [-128, 127]"
