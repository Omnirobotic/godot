...
class Metaclass(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._TYPE_SUPPORT = module.type_support_srv__srv_primitives
            from test_msgs.srv import _primitives__request
            if _primitives__request.Metaclass._TYPE_SUPPORT is None:
                _primitives__request.Metaclass.__import_type_support__()
            from test_msgs.srv import _primitives__response
...
class Primitives(metaclass=Metaclass):
    from test_msgs.srv._primitives__request import Primitives_Request as Request
    from test_msgs.srv._primitives__response import Primitives_Response as Response
