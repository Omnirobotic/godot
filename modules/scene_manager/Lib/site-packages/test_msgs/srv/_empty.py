...
class Metaclass(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._TYPE_SUPPORT = module.type_support_srv__srv_empty
            from test_msgs.srv import _empty__request
            if _empty__request.Metaclass._TYPE_SUPPORT is None:
                _empty__request.Metaclass.__import_type_support__()
            from test_msgs.srv import _empty__response
...
class Empty(metaclass=Metaclass):
    from test_msgs.srv._empty__request import Empty_Request as Request
    from test_msgs.srv._empty__response import Empty_Response as Response
