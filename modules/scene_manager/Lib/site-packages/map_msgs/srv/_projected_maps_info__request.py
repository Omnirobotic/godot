...
class Metaclass(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger('rosidl_generator_py.ProjectedMapsInfo_Request')
            logger.debug(
                'Failed to import needed modules for type support:\n' + traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv_projected_maps_info__request
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv_projected_maps_info__request
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv_projected_maps_info__request
            cls._TYPE_SUPPORT = module.type_support_msg__srv_projected_maps_info__request
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv_projected_maps_info__request
...
class ProjectedMapsInfo_Request(metaclass=Metaclass):
