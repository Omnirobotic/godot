...
class Metaclass(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg_battery_state
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg_battery_state
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg_battery_state
            cls._TYPE_SUPPORT = module.type_support_msg__msg_battery_state
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg_battery_state
...
class BatteryState(metaclass=Metaclass):
    ...
    def __init__(self, **kwargs):
        ...
        self.cell_voltage = kwargs.get('cell_voltage', [])
