...
namespace omni
{
    namespace scene
    {
        class document_node_serializer
            : public godot_style_node_serializer<document_node>
        {
        public:
        ...
        struct godot_style_document_node : public omni::serialization::format
        {
...
namespace omni
{
    namespace serialization
    {
        ...
        {
            typedef omni::scene::godot_style_document_node default_format_type;
        };
    }
}
#endif
